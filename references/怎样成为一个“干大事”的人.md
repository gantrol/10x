...
实际上，你不需要太担心第三个标准。在这方面，有野心的人往往对它过于保守。所以你只需要找到一些你有天赋并且非常感兴趣的东西。[^1]
...
有一种近乎痴迷的好奇心，既是“干大事”的动力和又是方向盘[^c]。它不仅会推动你，如果你允许它发挥作用，它也会向你展示应该从事什么工作。

你“超级好奇”什么——好奇到会让很多人厌烦？这就是你要找的。

一旦你找到了你“超级好奇”的东西，下一步就是学习足够的知识，使你能够接触到知识的前沿。知识的拓展方式就像地图海岸线[^d]，从远处看，它的边缘看起来很平滑，但一旦你学习足够多，接近其中一个边缘，你会发现它充满了缺口。
...
大胆追逐哪些“超纲”的想法，即便其他人对它不感兴趣——哦，改正一下，“尤其是其他人对它不感兴趣”。如果你对某种可能性感兴趣，其他人都忽视它，而你有足够的专业知识来精确说明他们忽视的是什么。那么，这将是你能找到的最好机会。[^3]
...
最大的奖励是找到所有“地图”都没有的“海岸线”[^e]。你注意到知识表面上的一个裂缝，把它撬开，里面就是一个全新的世界。
...
这篇文章是非常口语化的，译文也将顺延这一点，例子可见译注[^a]、[^d]。

[^a]: “great work”不会翻译成“伟业”，而是“干大事”。而且根据原作注释[^1]，“great work”的定义一般不明朗，衡量的标准也相当口语化，也很符合“大事”这个词。

[^b]: 部分原因是，这篇文章非常长

[^c]: 原文是舵，rubber

[^d]: 原文是“分形”（fractally），复杂系统的一个术语，出现在这篇口语化的文章，有点奇怪，故这里选择用一个经典例子替代——比例尺越小，海岸线长度越大，复杂度不变。它用来描述一种无限复杂、但是在各个尺度上都表现出相似性的结构。这种分形结构可以看作是知识的象征

[^e]: 原文是“分形芽”（fractal bud），这里沿用地图与海岸线的类比，避免突兀，详见[^d]
